  ...
  class SpriteWrapper extends Component {
    render = () => {
      ...
      const onClickHandler =
        this.props.onClickHandler == null ? null : this.props.onClickHandler;
      var style = {
        transform: ctrans,
        position: "absolute"
      };
...
export const Bird = observer(
  class Bird extends Component {
    render = () => {
      ...
      return (
        <SpriteWrapper gameSprite={this.props.bird}> {wbird} </SpriteWrapper>
      );
    };
  }
);
...
const Pipe = observer(
  class Pipe extends Component {
    render = () => {
      ...
      return (
        <SpriteWrapper gameSprite={this.props.pipe}> {wpipe} </SpriteWrapper>
      );
    };
  }
);
...
const Gameover = observer(
  class Gameover extends Component {
    render = () => {
      return (
        <SpriteWrapper gameSprite={{ cx: width / 2 - 94, cy: height - 400 }}>
          {" "}
          {gameover}{" "}
        </SpriteWrapper>
      );
...
export const OK = observer(
  class OK extends Component {
    render = () => {
      return (
        <SpriteWrapper
          gameSprite={{ cx: width / 2 - 40, cy: height - 340 }}
          onClickHandler={rungame}
        >
          {" "}
          {_ok_}{" "}
        </SpriteWrapper>
...
export const Splash = observer(
  class Splash extends Component {
    render = () => {
      return (
        <SpriteWrapper gameSprite={{ cx: width / 2 - 59, cy: height - 300 }}>
          {" "}
          {splash}{" "}
        </SpriteWrapper>
      );
